    ...
    <div style={{ padding: 28, overflow: 'auto', flex: 1 }}>
      ...
      <Card style={{ padding: 0, overflow: 'hidden' }}>
        ...
        {sorted.map((c) => {
          ...
          return (
            <div key={c.id} style={{ display: 'flex', alignItems: 'center', gap: 16, padding: '14px 20px', borderBottom: '1px solid #E8E8E8' }}>
              ...
              {c.health < 40 && (
                <button onClick={() => openContact(c)} style={{ padding: '6px 12px', background: '#DC2626', color: '#fff', borderRadius: 7, fontWeight: 600, fontSize: 12, flexShrink: 0, cursor: 'pointer', border: 'none' }}>
                  Kontaktieren
                </button>
              )}
            </div>
