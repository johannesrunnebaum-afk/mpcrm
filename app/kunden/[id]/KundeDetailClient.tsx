    ...
    <div style={{ padding: 28, overflow: 'auto', flex: 1 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5,1fr)', gap: 12, marginBottom: 20 }}>
        ...
        <Card style={{ padding: '14px 16px' }}>
          ...
          <div style={{ fontSize: 22, fontWeight: 700, color: c.nps >= 8 ? '#16A34A' : c.nps >= 6 ? '#EA580C' : '#DC2626' }}>{c.nps}/10</div>
        </Card>
        <Card style={{ padding: '14px 16px' }}>
          ...
          <div style={{ fontSize: 11, color: daysLeft <= 60 ? '#DC2626' : daysLeft <= 90 ? '#EA580C' : '#16A34A' }}>{daysLeft} Tage</div>
        </Card>
        <Card style={{ padding: '14px 16px' }}>
